          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label class="form-control-label" for="package">Kategori:</label>
            ...
            <div class="form-group">
              <label for="av" class="form-control-label">
                <input type="checkbox" id="av" name="is_available" value="1" <?php echo set_checkbox('is_available', '1', ($product->is_available == 1)); ?>> Apakah produk ini tersedia?
              </label>
            </div>
